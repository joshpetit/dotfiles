...
vim.keymap.set("n", "<leader>tt", [[:lua require("neotest").run.run({suite = true})<cr>]])
...
vim.keymap.set("n", "<leader>td", [[:lua require("neotest").run.run_last({ strategy = "dap" })<cr>]])
...
vim.keymap.set("n", "<leader>cpl", [[:let @+ = fnamemodify(expand("%"), ":~:.") . ':' . line('.')<cr>]])
vim.keymap.set("n", "<leader>cpp", [[:let @+ = fnamemodify(expand("%"), ":~:.")<cr>]])
vim.keymap.set("n", "<leader>cpf", [[:let @+ = expand('%:t')<cr>]])
...
m.nmap("<leader>gla", "<cmd>!git ls-files -v | grep '^[[:lower:]]'<CR>")
...
m.nmap("<leader>de", "<cmd>lua require'dap'.set_exception_breakpoints()<cr>")
m.nmap("<leader>dh", "<cmd>lua require'dap.ui.widgets'.hover()<CR>")
m.nmap("<leader>dr", "<cmd>lua require'dap'.repl.open()<CR>")
m.nmap("<leader>dR", "<cmd>lua require'dap'.restart()<CR>")
m.nmap("<leader>dtc", "<cmd>lua require'dap'.run_to_cursor()<CR>")
